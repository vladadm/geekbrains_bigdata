...
CREATE TABLE `private_channels` (
    id SERIAL,
	-- `chfnnel_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
	`name` VARCHAR(100),  -- а нужно-ли?
...
DROP TABLE IF EXISTS `private_channel_messages`;
...
DROP TABLE IF EXISTS `private_messages_status`;
CREATE TABLE `private_channel_messages_status` (
	`message_id` BIGINT UNSIGNED NOT NULL,
	`owner_read_status` ENUM('read', 'unread'),
	`recipient_read_status` ENUM('read', 'unread'),
	
	INDEX messages_status_idx(message_id),
	FOREIGN KEY (message_id) REFERENCES private_channel_messages(id)
);
...
INSERT INTO vk.users( firstname, lastname, email, password_hash, phone ) 
VALUES ('Виктор', 'Юрьевич', 'vy@email', 'sha256::', '+7000000'), 
	('111', 'Валсильевич', 'gv@email', 'sha256::', '+74951234567');
...
/*INSERT INTO vk.users(	
    ...
    lastname, 
    email,
 	password_hash, -- 123456 => vzx;clvgkajrpo9udfxvsldkrn24l5456345t
	phone
) 
VALUES ('Геннадий', 'Валсильевич', 'test@email', 'sha256::', '+7000000');
*/
select * from users;

INSERT INTO vk.profiles(user_id, gender, birthday, photo_id, hometown) 
VALUES ('1', 'm', '2021-08-25 21:29:44', '001324543534', 'Moscow' );

-- INSERT INTO vk.profiles(user_id, gender, birthday, photo_id, hometown) 
-- VALUES ('2', 'm', '1970-08-25 21:29:44', '001324543534', 'Moscow' );
